...
public class Whacknet {
  ...
  /**
   * Gets the X position of a detected object.
   *
  ...
  /**
   * Gets the Y position of a detected object.
   *
   * @param i The index of the observation.
  ...
  /**
   * Gets the rotation of a detected object.
   *
   * @param i The index of the observation.
  ...
  /**
   * Gets the standard deviation of the X position estimate.
   *
   * @param i The index of the observation.
  ...
  /**
   * Gets the standard deviation of the Y position estimate.
   *
   * @param i The index of the observation.
   * @return Standard deviation in meters.
   */
  ...
  /**
   * Gets the standard deviation of the rotation estimate.
   *
   * @param i The index of the observation.
  ...
  /**
   * Gets the FPGA timestamp of the observation.
   *
   * @param i The index of the observation.
  ...
  /**
   * Gets the ID of the camera that made the observation.
   *
   * @param i The index of the observation.
   * @return Camera ID.
   */
  ...
  /**
   * Gets the number of AprilTags detected in the observation.
   *
   * @param i The index of the observation.
