...
public class ModuleIOSpark implements ModuleIO {
    ...
    public ModuleIOSpark(int module) {
        ...
        turnEncoderConfig.MagnetSensor.SensorDirection = turnEncoderInverted
    ...
    public void updateInputs(ModuleIOInputs inputs) {
        ...
        // Update turn inputs
        currentTurnPosition = new Rotation2d(turnEncoder.getPosition().getValueAsDouble() * turnEncoderPositionFactor)
                .minus(zeroRotation);
        inputs.turnPosition = currentTurnPosition;

        inputs.turnVelocityRadPerSec = turnEncoder.getVelocity().getValueAsDouble() * turnEncoderVelocityFactor;
    ...
    public void setTurnPosition(Rotation2d rotation) {
        double output = turnFeedbackController.calculate(currentTurnPosition.getRadians(), rotation.getRadians());
        turnSpark.setVoltage(output);
    }
}