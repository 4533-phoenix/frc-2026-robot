...
public class DriveConstants {
  ...
  public static final Rotation2d frontLeftZeroRotation = Rotation2d.fromDegrees(83.0);
  public static final Rotation2d frontRightZeroRotation = Rotation2d.fromDegrees(324.0);
  public static final Rotation2d backLeftZeroRotation = Rotation2d.fromDegrees(196.0);
  public static final Rotation2d backRightZeroRotation = Rotation2d.fromDegrees(11.0);

  // Device CAN IDs
  public static final int imuCanId = 0; // Unused, using NavX SPI
  ...
  public static final double wheelRadiusMeters = Units.inchesToMeters(1.936);
  ...
  public static final double turnKp = 3.1;
