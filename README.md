<img alt="Banner" src="https://github.com/user-attachments/assets/441e96cc-9e39-4cf6-8d3b-aa79dd3b2f32" />
...
<img alt="Phoenix's 2026 Robot: Phossil" src="https://github.com/user-attachments/assets/0d3b453d-c6e3-4b8e-a21c-d368655f52bf" />
...
- **[Whacknet: Zero-Allocation Vision](https://github.com/4533-Phoenix/frc-2026-robot/wiki/Whacknet:-UDP-Vision-Protocol):** A custom C/JNI UDP server that parses vision data from our coprocessor ([Chalkydri](https://github.com/chalkydri/chalkydri) or [PhotonVision](https://github.com/4533-phoenix/photonvision)). It uses a lock-free ring buffer, kernel-level timestamps, and the Java Flyweight pattern to achieve ultra-low latency with zero memory allocation.
